...
sub eprintpages {
    ...
    my $pages = $bibitem->get_pages();

    if (nonempty($bibitem->get_eprint())) {
        if (empty($bibitem->get_journal())) {
            $pages .= " pp.";
        }
    }
...
sub print_doi {
    ...
    return sprintf q{\PrintDOI{%s}}, __doi_url($field);
}
...
$BIB_SPEC{eprint} = [
    ...
    [ title      => q{,}, q{ }, q{format_title} ],
    [ subtitle   => q{:}, q{ }, [ apply_style => 'textit' ] ],
    [ arxiv      => q{,}, q{ }, [ apply_style => 'arXiv' ] ],
    [ date       => q{},  q{ }, \&print_date_pv ],
    [ transition => q{.}, q{},  q{} ],
];

$BIB_SPEC{wiki} = [
    [ wiki       => q{} , q{} , [ apply_style => 'emph' ] ],
    [ title      => q{,}, q{ }, [ apply_style => 'wikititle' ] ],
    [ date       => q{,}, q{ }, [ apply_style => 'PrintAccessDate' ] ],
    [ wikiurl    => q{,}, q{ }, [ apply_style => 'wikiurl' ] ],
    [ transition => q{.}, q{} ,      q{} ],
];
